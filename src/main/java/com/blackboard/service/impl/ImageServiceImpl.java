...
public class ImageServiceImpl implements ImageService {
	 ...
	 * 展示当前黑板报所有图片
	 * @param enterpriseId      企业ID
	 * @param blackboradId      黑板报ID
	 * @return List<Image>      图片列表
	 */
	@Override
	public List<Image> getBlackboardImage(String enterpriseId,
			String blackboradId) {
	 ...
	 */
	@Override
	public Boolean updateBlackboardImage(String enterpriseId, String blackboradId,MultipartFile[] images,String serverPath){
