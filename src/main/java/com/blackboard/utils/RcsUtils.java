...
import com.cmic.rcsmatrix.constant.WebConst;
import com.cmic.rcsmatrix.exception.RcsException;
import com.cmic.rcsmatrix.pojo.User;
...
public class RcsUtils {
    private static final Logger LOGGER = LoggerFactory.getLogger(RcsUtils.class);
    ...
    *//**
     * 获取文件所在目录
     *//*
    private static String location = RcsUtils.class.getClassLoader().getResource("").getPath();
...
//            默认是classPath路径
        ...
        } catch (RcsException | IOException e) {
...
//            return prefix + "/" + UUID.UU32() + "." + (ext == null ? null : (ext));
    ...
    *//**
    ...
    public static String getUplodFilePath() {
        String path = RcsUtils.class.getProtectionDomain().getCodeSource().getLocation().getPath();
