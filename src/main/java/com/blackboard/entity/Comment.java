...
public class Comment {
	...
	public String toString() {
		return "Comment [commentId=" + commentId + ", blackboardId="
				+ blackboardId + ", replyId=" + replyId + ", commenterId="
				+ commenterId + ", commentContent=" + commentContent
				+ ", commenTime=" + commentTime + ", enterpriseId="
				+ enterpriseId + "]";
	}
